...
<div id="container">
      ...
      <div class="col-3">
        <div class="card border-danger golge" style="background-color: #E6E6FA;">
            ...
            <div class="card-header text-center" style="font-weight: bold;font-size: 19px">
              <p href="arkadaslar.html" target="_blank" class="isteColor">
                <h6><strong>Anonymes Connectés</strong></h6>
              </p>
            </div>
 ...
 <div id="on_box">
  ...
  <div class="col-9 ">
        <div  style="margin-left: 35%;font-weight: bold;font-size: 19px">
              <p target="_blank" class="isteColor">
                <h6><strong>Discussion</strong></h6>
              </p>
            </div>
  <div class="card border-danger" style="background-color: #E6E6FA;" id="chat_box">
    <div id="chat"></div>
  </div>
